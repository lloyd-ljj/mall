package cn.edu.shu.mall.product.controller;

import java.util.Arrays;
import java.util.HashMap;
import java.util.Map;

import cn.edu.shu.common.valid.AddGroup;
import cn.edu.shu.common.valid.UpdateGroup;
import cn.edu.shu.common.valid.UpdateStatusGroup;
...
//                // 获取错误提示
//                String messages = item.getDefaultMessage();
//                // 获取错误属性名
